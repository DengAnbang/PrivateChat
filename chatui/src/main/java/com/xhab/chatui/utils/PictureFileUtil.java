...
public class PictureFileUtil {
    private static PictureSelectionModel get(PictureSelectionModel pictureSelectionModel) {
        pictureSelectionModel.theme(R.style.picture_my_style)// 主题样式设置 具体参考 values/styles   用法：R.style.picture.white.style
                .imageSpanCount(3)// 每行显示个数
                .selectionMode(6 > 1 ? PictureConfig.MULTIPLE : PictureConfig.SINGLE)// 多选 or 单选
...
//                        .videoMinSecond(10)
                ...
                //.videoSecond()//显示多少秒以内的视频or音频也可适用
                //.recordVideoSecond()//录制视频秒数 默认60s
                .loadCacheResourcesCallback((context, url) -> {
