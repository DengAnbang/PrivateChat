package com.xhab.chatui.widget;
...
public class StateButton extends AppCompatButton {
    ...
    private void setup(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ChatStateButton);
        ...
        mNormalTextColor = a.getColor(R.styleable.ChatStateButton_normalTextColor, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.ChatStateButton_pressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.ChatStateButton_unableTextColor, mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.ChatStateButton_animationDuration, mDuration);
        mStateBackground.setEnterFadeDuration(mDuration);
        mStateBackground.setExitFadeDuration(mDuration);

        //set background color
        mNormalBackgroundColor = a.getColor(R.styleable.ChatStateButton_normalBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.ChatStateButton_pressedBackgroundColor, 0);
        mUnableBackgroundColor = a.getColor(R.styleable.ChatStateButton_unableBackgroundColor, 0);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.ChatStateButton_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.ChatStateButton_strokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.ChatStateButton_normalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.ChatStateButton_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.ChatStateButton_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.ChatStateButton_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.ChatStateButton_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.ChatStateButton_unableStrokeColor, 0);
        setStroke();
